...
export const MASSES = {
    ...
    // Sigma (Σ)
    "Σ+": 1189.4,    // Sigma plus (Spin 1/2)
    "Σ0": 1192.6,    // Sigma zero (Spin 1/2)
    "Σ-": 1197.4,    // Sigma minus (Spin 1/2)
    
    // Xi (Ξ)
    "Ξ0": 1314.9,       // Xi zero (Spin 1/2)
    "Ξ-": 1321.7,       // Xi minus (Spin 1/2)
    ...
    "Λc+": 2286.5,  // Lambda c plus
    "Σb-": 5815.6,   // Sigma b minus
